package com.opxdemon.terminal.frontend.floating
...
import com.opxdemon.terminal.component.session.ShellTermSession
import com.opxdemon.terminal.frontend.session.terminal.BasicSessionCallback
import com.opxdemon.terminal.frontend.session.terminal.BasicViewClient
...
import com.opxdemon.terminal.utils.Terminals
import java.util.*
...
class TerminalDialog(val context: Context) {
  ...
  fun execute(executablePath: String, arguments: Array<String>?): TerminalDialog {
    ...
    val arguments_out = arguments?.joinToString("")

    val parameter = ShellParameter()
      .executablePath(executablePath)
      .initialCommand(arguments_out)
...
class WindowTermView(val context: Context) {
  ...
  fun setTerminalViewClient(terminalViewClient: com.opxdemon.terminal.frontend.session.view.TerminalViewClient?) {
