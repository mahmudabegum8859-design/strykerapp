package com.opxdemon.terminal.services
...
import com.opxdemon.terminal.ui.term.NeoTermActivity
...
class NeoTermService : Service() {
  ...
  private fun createNotification(): Notification {
    ...
    builder.setSmallIcon(R.drawable.icon_svg)
  ...
  private fun createNotificationChannel() {
    ...
    val channel = NotificationChannel(DEFAULT_CHANNEL_ID, "OPXDemon", NotificationManager.IMPORTANCE_LOW)
    channel.description = "OPXDemon Notifications"
