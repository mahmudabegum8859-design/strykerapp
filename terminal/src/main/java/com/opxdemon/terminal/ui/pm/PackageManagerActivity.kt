package com.opxdemon.terminal.ui.pm
...
import com.opxdemon.terminal.component.pm.*
import com.opxdemon.terminal.utils.StringDistance
import com.opxdemon.terminal.utils.runApt
import java.util.*
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    adapter = PackageAdapter(this, comparator, object : PackageAdapter.Listener {
      override fun onModelClicked(model: PackageModel) {
        MaterialAlertDialogBuilder(this@PackageManagerActivity)
