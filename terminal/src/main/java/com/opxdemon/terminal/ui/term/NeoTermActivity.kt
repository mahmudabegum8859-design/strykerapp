...
import com.opxdemon.terminal.frontend.floating.TerminalDialog
import com.opxdemon.terminal.frontend.session.terminal.*
...
import com.opxdemon.terminal.ui.other.SettingsActivity
import com.opxdemon.terminal.ui.other.WirelessDialogs
import com.opxdemon.terminal.utils.FullScreenHelper
import com.opxdemon.terminal.utils.NeoPermission
import com.opxdemon.terminal.utils.RangedInt
...
class NeoTermActivity : AppCompatActivity(), ServiceConnection, SharedPreferences.OnSharedPreferenceChangeListener {
  companion object {
    ...
    const val EXTRA_NEW_SESSION = "com.opxdemon.terminal.NEW_SESSION"
  }
  ...
  override fun onOptionsItemSelected(item: MenuItem): Boolean {
    return when (item.itemId) {
      ...
      R.id.menu_item_new_session -> {
        addNewOPXDemonSession("OPXDemon")
        true
      }
  ...
  private fun addNewSessionWithProfile(
    ...
    session.mSessionName = sessionName ?: generateSessionName("OPXDemon")
  ...
  private fun addNewOPXDemonSession(sessionName: String?) {
    val sessionCallback = TermSessionCallback()
    val viewClient = TermViewClient(this)
  ...
  private fun createXTab(tabTitle: String?): Tab {
    return postTabCreated(XSessionTab(tabTitle ?: "OPXDemon"))
  }
