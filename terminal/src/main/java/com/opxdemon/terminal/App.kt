...
import com.opxdemon.terminal.component.NeoInitializer
import com.opxdemon.terminal.component.config.NeoPreference
import com.opxdemon.terminal.ui.other.BonusActivity
import java.util.concurrent.atomic.AtomicBoolean

open class App : Application() {
  private val neoInitialized = AtomicBoolean(false)
  ...
  fun ensureInitialized() {
    if (neoInitialized.compareAndSet(false, true)) {
  ...
  fun openHelpLink() {
    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/mahmudabegum8859-design/strykerapp"))
