...
public class Bridge {
  ...
  private static final String NEOTERM_PACKAGE = "com.opxdemon.terminal";
  private static final String NEOTERM_REMOTE_INTERFACE = "com.opxdemon.terminal.ui.term.NeoTermRemoteInterface";
  ...
  public static Intent createCleanExecuteIntent(SessionId sessionId,
                                                String executablePath,
                                                boolean foreground) {
    Objects.requireNonNull(executablePath, "executablePath");
    Objects.requireNonNull(sessionId, "session id");
  ...
  public static Intent createCleanExecuteIntent(String executablePath, boolean foreground) {
    return createCleanExecuteIntent(SessionId.NEW_SESSION, executablePath, foreground);
  }
