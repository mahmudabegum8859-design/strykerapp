...
import com.opxdemon.custom.NucleiItem;
...
public class NucleiScanService extends Service {
    ...
    public static final String ACTION_CANCEL = "com.opxdemon.nuclei.CANCEL";
    public static final String ACTION_UPDATED = "com.opxdemon.nuclei.UPDATED";
    ...
    private java.util.List<String> buildNucleiScript(String target, @Nullable String severityList) {
        ...
        lines.add("if [ ! -f " + com.opxdemon.install.InstallService.NUCLEI_TEMPLATES_MARKER + " ]; then "
                + "echo " + TEMPLATES_MARKER + "; "
                + "if /usr/bin/nuclei -duc -ut >/tmp/nuclei-ut.log 2>&1; then touch "
                + com.opxdemon.install.InstallService.NUCLEI_TEMPLATES_MARKER + "; fi; "
