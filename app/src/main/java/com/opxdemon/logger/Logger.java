...
public class Logger {
    ...
    public void generateNmapReport(String ip, ArrayList<String> output) {
        ...
        @SuppressLint("SdCardPath") String path = "/data/data/com.opxdemon/files/reports/";
        ...
        try {
            ...
            editor.append("=====[Powered by OPXDemon " + BuildConfig.VERSION_NAME + "]=====" + "\n\n");
