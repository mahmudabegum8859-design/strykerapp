package com.opxdemon.localnetwork;
...
import com.opxdemon.exploithub.utils.BasicExploitLaunch;
import com.opxdemon.localnetwork.utils.NmapReportGenerator;
import com.opxdemon.metasploit.InstallMetasploit;
import com.opxdemon.utils.AdvancedProcess;
import com.opxdemon.utils.AdvancedProcessList;
...
public class LocalAdapter extends RecyclerView.Adapter<LocalAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder adapter, @SuppressLint("RecyclerView") final int position) {
        ...
        if (vendorText == null || vendorText.trim().isEmpty()) {
            vendorText = com.opxdemon.localnetwork.utils.MacLine.stripMac(device.getVendor());
        }
        ...
        new Thread(() -> {
            ...
            activity.runOnUiThread(() -> {
                if (installed) {
                    ...
                    com.opxdemon.hydra.HydraDialog.show(context, activity, core, device);
                    return;
                }
                FragmentManager manager = ((AppCompatActivity) context).getSupportFragmentManager();
                manager.beginTransaction()
                        .replace(R.id.flContent, new com.opxdemon.hydra.HydraInstall())
                        .commit();
            });
        }, "hydra-check").start();
    }
    ...
    private void launchCameradar(String ip) {
        new Thread(() -> {
            ...
            activity.runOnUiThread(() -> {
                ...
                FragmentManager manager = ((AppCompatActivity) context).getSupportFragmentManager();
                manager.beginTransaction()
                        .replace(R.id.flContent, new com.opxdemon.cameradar.CameradarInstall())
                        .commit();
            });
    ...
    private void generatePayload() {
        com.opxdemon.metasploit.PayloadGenerator.show(context, activity, core);
    }
