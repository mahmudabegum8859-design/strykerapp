...
import com.opxdemon.utils.AdvancedThread;
import com.opxdemon.utils.Core;
import com.opxdemon.utils.MonitorManager;
import com.opxdemon.utils.SimpleProcess;
...
public class WiFIAdapter extends RecyclerView.Adapter<WiFIAdapter.ViewHolder> {
    ...
    public void newWifiDialog(WiFINetwork network){
        ...
        wps_lock.setOnClickListener(view -> {
            MaterialAlertDialogBuilder d = new MaterialAlertDialogBuilder(context)
                    .setTitle("WPS Locked")
                    .setMessage("OPXDemon detected that this network is WPS Locked. This means that you can't use WPS to connect to this network. You can still try wps attacks, but they will fail.")
    ...
    public void attackDialog(WiFINetwork network, int type){
        ...
        if (type == 1){
            ...
            pixie = new AdvancedProcess(activity, context, cmd, true) {
                ...
                public void onFinished(ArrayList<String> outputList) {
                    ...
                    if (result.getOK()){
                        ...
                        com.opxdemon.geomac.GeoHooks.recordPixie(
            ...
            ArrayList<String> get = core.getListFiles(core.getStorage() + "OPXDemon/wordlists/");
            if (!get.isEmpty()){
                String[] w2 = new String[get.size()];
                for (int i = 0; i < get.size(); i++) {
                    w2[i] = get.get(i).replace(core.getStorage() + "OPXDemon/wordlists/", "");
                }
                new MaterialAlertDialogBuilder(context)
                        ...
                        .setItems(w2, (dialogInterface, i) -> {
                            ...
                            brutepsk = new AdvancedThread(activity, context) {
                                ...
                                public void doOnBackground() {
                                    try (BufferedReader br = new BufferedReader(new FileReader(core.getStorage() + "OPXDemon/wordlists/"+wordlistpath))) {
                                        String psk;
                    ...
                    if (monitor && monitor2){
                        ...
                        if (!airoRunning[0]){
                            ...
                            if (saved == null) {
                                ...
                                com.opxdemon.geomac.GeoHooks.recordHandshake(
                                        context, network.getMac(), network.ssid);
                            }
