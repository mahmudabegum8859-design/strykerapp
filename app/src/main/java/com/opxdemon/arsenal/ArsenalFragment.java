...
public class ArsenalFragment extends Fragment {
    ...
    private void styleTabs() {
        ...
        if (hub) {
            ...
            tabHubIcon.setColorFilter(ContextCompat.getColor(context, R.color.opxdemon_accent));
            ...
            tabDbIcon.setColorFilter(ContextCompat.getColor(context, R.color.opxdemon_accent));
