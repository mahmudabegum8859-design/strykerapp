...
import com.opxdemon.hid.capability.HidCapabilities;
import com.opxdemon.hid.capability.HidCapabilityProbe;
import com.opxdemon.hid.configfs.GadgetFunction;
import com.opxdemon.hid.configfs.GadgetProfile;
import com.opxdemon.hid.configfs.UsbGadgetController;
import com.opxdemon.hid.ducky.Program;
import com.opxdemon.hid.ducky.Step;
import com.opxdemon.hid.exec.ExecutionResult;
import com.opxdemon.hid.exec.HidExecutor;
import com.opxdemon.hid.keymap.KeymapRegistry;
import com.opxdemon.hid.payload.PayloadLibrary;
import com.opxdemon.hid.ui.editor.DuckySyntaxHighlighter;
import com.opxdemon.hid.ui.editor.LinedEditText;
import com.opxdemon.hid.ui.editor.LiveSyntaxValidator;
import com.opxdemon.hid.ui.editor.PayloadFileIo;
import com.opxdemon.usbarsenal.GadgetProfileDb;
    ...
    private final HidExecutor.ProgressSink sink = new HidExecutor.ProgressSink() {
        ...
        public void onOpenViewer(@NonNull Step step) {
            ...
            Intent i = new Intent(HidIdeActivity.this,
                    com.opxdemon.hid.backchannel.ScreenViewerActivity.class);
