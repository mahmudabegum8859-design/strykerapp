...
import com.opxdemon.hid.payload.Payload;
...
public class HidFragment extends Fragment implements PayloadCardAdapter.OnPayloadClicked {
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        String savedFilter = new com.opxdemon.utils.Core(requireContext())
        ...
        filterInput.addTextChangedListener(new TextWatcher() {
            ...
            @Override public void onTextChanged(CharSequence s, int a, int b, int c) {
                ...
                new com.opxdemon.utils.Core(requireContext()).putString(PREF_FILTER, text);
                applyFilter(text);
            }
        ...
        new com.google.android.material.dialog.MaterialAlertDialogBuilder(requireContext())
                ...
                .setPositiveButton(android.R.string.ok, (d, w) -> {
                    ...
                    if (library.rename(payload, newName)) {
                        new com.opxdemon.utils.Core(requireContext())
