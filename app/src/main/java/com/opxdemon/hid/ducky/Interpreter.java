package com.opxdemon.hid.ducky;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import com.opxdemon.hid.backchannel.AcmChannel;
import com.opxdemon.hid.keymap.KeyEntry;
import com.opxdemon.hid.keymap.Keymap;
import com.opxdemon.hid.report.HidReportStream;
import com.opxdemon.hid.report.KeyReport;
import com.opxdemon.hid.report.MouseReport;
...
public final class Interpreter {
    ...
    private void typeString(@NonNull Step.TypeString step) throws IOException, InterruptedException {
        ...
        if (step.trailingEnter) {
            keyboard.sendKey(KeyReport.singleKey(0, com.opxdemon.hid.report.UsbHid.KEY_ENTER));
            releaseIfNotHeld();
        }
    }
