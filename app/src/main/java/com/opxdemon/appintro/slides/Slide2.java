...
public class Slide2 extends Fragment {
    ...
    private void tryGrant() {
        ...
        new Thread(() -> {
            ...
            if (rooted || rootless) {
                if (rooted) {
                    core.customCommand("pm grant com.opxdemon android.permission.WRITE_EXTERNAL_STORAGE", true);
                    core.customCommand("pm grant com.opxdemon android.permission.READ_EXTERNAL_STORAGE", true);
    ...
    private boolean batteryWhitelisted() {
        try {
            ...
            return pm != null && pm.isIgnoringBatteryOptimizations("com.opxdemon");
        } catch (Throwable t) {
            return false;
        }
    }
    ...
    private void copyAssets() {
        ...
        for (String filename : files) {
            ...
            try {
                ...
                @SuppressLint("SdCardPath") File outFile = new File("/data/data/com.opxdemon/files/", filename);
        ...
        if (!core.isRootless()) {
            core.customCommand("dos2unix /data/data/com.opxdemon/files/*.sh", true);
            core.customCommand("dos2unix /data/data/com.opxdemon/files/*root*", true);
        }
    }
